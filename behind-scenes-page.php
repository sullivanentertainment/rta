...
<li class="video-wrapper">
    <div class="content-wrapper">
        <h3 class="youtube-title"><?php echo the_title(); ?></h3>
        <p><?php echo the_content(); ?></p>
    </div>
    <div class="youtube-player" data-id="<?php echo CFS()->get('url'); ?>"></div>
...
Thanks to the efforts of Mann and Secord, the lush, visually stimulating costuming of these films will continue to impress for generations to come.</p></div>
                          ...
                          <img class="set-design-bg" style="width:100vw" src="<?php echo get_template_directory_uri(); ?>/assets/images/set-design-bg.jpg"/>
                           <div class="container">
                            ...
                            <div class="before-after-wrapper wrap1">
                                 <?php echo do_shortcode('[bs_image_comparison id="29628"]'); ?>
                            <div class="set-1">
                       ...
                       <div class="before-after-wrapper">
                           ...
                           <h3 class="trajan" style="margin-top:0;">Where Did This All Happen?</h3>
                            ...
                            <?php echo do_shortcode("[bs_image_comparison id='29633']"); ?>
                       </div>
